...
@Service
public class DefaultSigningCertificateService {

    public CertificateConstraints setDefaultRules(CertificateConstraints certificateConstraints)
            throws XMLStreamException, JAXBException, IOException, SAXException {
        CertificateConstraints baseCertConstraints = ValidationPolicyFacade.newFacade().getDefaultValidationPolicy().getSignatureConstraints().getBasicSignatureConstraints().getSigningCertificate();
        if(certificateConstraints == null)
            return baseCertConstraints;

        return merge(certificateConstraints, baseCertConstraints);
    }
     ...
     * @param certificateConstraints The source CertificateConstraint
     * @param baseCertConstraints The target CertificateConstraint where they were merged to
     * @return The merged certificate constraints
     */
    private CertificateConstraints merge(CertificateConstraints certificateConstraints, CertificateConstraints baseCertConstraints){
